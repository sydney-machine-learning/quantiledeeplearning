...
print("Import Successful. Models are running, Please Wait Patiently...")
...
for i in tqdm(range(num_exp)):
	...
	for q in quantiles:
		...
		initial_beta = np.zeros((X_train.shape[1] * X_train.shape[2], 
			output_size)).flatten()
		result = minimize(tilted_loss, initial_beta, args = (X_train_reshaped, 
			y_train, q), method = 'BFGS')
		...
		# {0.05: [1021, 5], 0.25: [1021, 5], 0.5: [1021, 5], 
		# 0.75: [1021, 5], 0.95: [1021, 5]}
